...
int main(int argc, char *args[]) {
	...
	DECLARE_INSTRUCTION(30, "JMPC", addr);
	DECLARE_INSTRUCTION(31, "CEQ", addr);
	DECLARE_INSTRUCTION(32, "CNE", addr);
	DECLARE_INSTRUCTION(33, "CGT", addr);
	DECLARE_INSTRUCTION(34, "CGE", addr);
	DECLARE_INSTRUCTION(35, "CLT", addr);
	DECLARE_INSTRUCTION(36, "CLE", addr);
