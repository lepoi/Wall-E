...
int main(int argc, char *args[]) {
	...
	DECLARE_INSTRUCTION(29, "JMP", addr);
	DECLARE_INSTRUCTION(30, "JPE", addr);
	DECLARE_INSTRUCTION(31, "JPNE", addr);
	DECLARE_INSTRUCTION(32, "JPG", addr);
	DECLARE_INSTRUCTION(33, "JPGE", addr);
	DECLARE_INSTRUCTION(34, "JPL", addr);
	DECLARE_INSTRUCTION(35, "JPLE", addr);
	...
	DECLARE_INSTRUCTION(41, "WRTS", kstring);
