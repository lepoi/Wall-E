...
int main(int argc, char *args[]) {
	...
	*/
	...
	DECLARE_INSTRUCTION(15, "ADD", NULL);
	DECLARE_INSTRUCTION(16, "SUB", NULL);
	DECLARE_INSTRUCTION(17, "MUL", NULL);
	DECLARE_INSTRUCTION(18, "DIV", NULL);
	DECLARE_INSTRUCTION(19, "MOD", NULL);
	/*
	DECLARE_INSTRUCTION(1, "EXT", NULL);
